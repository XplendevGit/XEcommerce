...
const Portada = () => {
  ...
  return (
    <div className="w-full h-screen bg-fondoprimary container">
{/* DIV Central */}
      ...
      {/* DIV 1 */}
        <div className={` ${style['portada-1']}` }>
          ...
          <div className="w-full h-full flex flex-col justify-center lg:pb-32 space-y-1">
             ...
             <h1 className="xl:tracking-[0.8em] lg:tracking-[0.3em] md:tracking-[0.2em] tracking-[0.04em]" style={{ textShadow: '8px 4px 4px rgba(0,0,0,0.5)' }}>EXPERIENCES</h1>
       ...
       {/* DIV 2 */}
        <div className={` z-10 flex justify-center items-center lg:justify-center lg:items-center ${style['portada-2']}` }>
          {/* Objeto 3d Spline */}
                ...
                <div 
            className="flex w-auto h-[480px] md:w-[590px] md:h-[580px] xl:w-[790px] xl:h-[780px] xl:pb-12 ">
                {loading ? (
